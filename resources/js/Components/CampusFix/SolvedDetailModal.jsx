                                ...
                                return (
                                    <span 
                                        ...
                                        style={{ 
                                            ...
                                            borderColor: theme.bg === '#212121' ? 'rgba(255, 255, 255, 0.35)' : `${theme.bg}70`,
                                ...
                                return (
                                    <span 
                                        style={{ 
                                            ...
                                            borderColor: theme.bg === '#212121' ? 'rgba(255, 255, 255, 0.3)' : `${theme.bg}50`,
                                            color: theme.bg === '#212121' ? '#FFFFFF' : (theme.text === '#14130B' ? '#FBBF24' : theme.bg)
                                        }}
                            ...
                            {issue.taggedDepartments && issue.taggedDepartments.map((tag, idx) => {
                                ...
                                return (
                                    <span 
                                        key={'tag-' + idx} 
                                        style={{ 
                                            backgroundColor: theme.bg === '#212121' ? 'rgba(255, 255, 255, 0.1)' : `${theme.bg}15`, 
                                            borderColor: theme.bg === '#212121' ? 'rgba(255, 255, 255, 0.3)' : `${theme.bg}50`,
                                            color: theme.bg === '#212121' ? '#FFFFFF' : (theme.text === '#14130B' ? '#FBBF24' : theme.bg)
                                        }}
                                        className="shrink-0 rounded px-1.5 py-0.5 font-mono text-[10px] font-medium border flex items-center gap-1" 
